    ...
    this.setState(
      {
        ...
        modalVisible: false // <-- Close modal on select
      },
      () => {
    ...
    return (
      <CountryModalProvider>
        ...
        >
          ...
          >
            {/* --- 2. COUNTRYPICKER REMOVED FROM HERE, FLAG ADDED MANUALLY --- */}
          ...
          {/* --- 3. MODAL WITH COUNTRYPICKER ADDED HERE --- */}
          {modalVisible && (
            <Modal
              visible={true}
              animationType="none"
            ...
            >
              <CountryPicker
                ...
                countryCode={countryCode}
                withCallingCode
                disableNativeModal={false} // <-- The critical fix
                visible={true} // <-- Picker is now inside the modal
                theme={withDarkTheme ? DARK_THEME : DEFAULT_THEME}
                renderFlagButton={this.renderFlagButton} // This is for the picker's internal UI
